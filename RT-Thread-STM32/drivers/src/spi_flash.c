...
* Description    : Erases the specified FLASH sector.4K
...
* Description    : Erases the specified FLASH Block.64K
...
u8 SPI_FLASH_ISBUSY(void)
{
	...
	if((FLASH_Status & WIP_Flag) == SET) /* Write in progress */
		return 1;
	else 
		return 0;
}
